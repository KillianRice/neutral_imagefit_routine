...
for basenameNum = 1:analyVar.numBasenamesAtom
    ...
    for k = 1:indivDataset{basenameNum}.CounterAtom
        ...
        if viewCloudCut;
            ...
            hCloud(k) = subaxis(indivDataset{basenameNum}.SubPlotRows,indivDataset{basenameNum}.SubPlotCols,k,...
            ...
            %%% Plot axis details
            title(strcat(num2str(indivDataset{basenameNum}.imagevcoAtom(k)),'-',num2str(k)));
            ...
            hCloud2(k) = subaxis(indivDataset{basenameNum}.SubPlotRows,indivDataset{basenameNum}.SubPlotCols,k,...
                'SpacingVert'   ,   analyVar.subAxis.spacingVert,...
                'SpacingHoriz'  ,   analyVar.subAxis.spacingHoriz,...
                'Margin'        ,   analyVar.subAxis.margin,...
                'MarginTop'     ,   analyVar.subAxis.marginTop,...
