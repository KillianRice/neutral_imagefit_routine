...
%% Guessing
[peakTime,peakLoc] = findpeaks(smooth(pos,'sgolay'),'minpeakdistance',1,'minpeakheight',mean(pos));
...
dataH = plot(time*1e3,pos,'ro',timeInterp*1e3,s2(modOscFit,timeInterp),'--');
grid on; axis tight
set(gcf,'color','white')
xlabel('Time [ms]','FontSize',24,'FontWeight','Bold')
ylabel('Center Position','FontSize',24,'FontWeight','Bold')
set(dataH(1),'MarkerSize',10,'MarkerFaceColor',[0.851 0.325 0.098],'MarkerEdgeColor',[0.851 0.325 0.098])
set(dataH(2),'LineWidth',2,'Color',[0 0.447 0.741])
