function groundStatePop = OBE_3P1(omegaRabi,gammaLife,delta,gammaCoh,tMax,flagPlot)
...
%gammaCoh  = 2*pi*15e3;  %[s^-1] empirical laser linewidth of 3P1 laser

% Computational variables
tRange   = linspace(0,tMax,1e3); % in units of Rabi periods
