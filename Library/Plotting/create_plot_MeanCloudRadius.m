...
for uniqScanIter = 1:length(analyVar.uniqScanList);
    ...
    avgCloudRadX = avgDataset{uniqScanIter}.avgCloudRadX;   stdCloudRadX = avgDataset{uniqScanIter}.stdCloudRadX;
    avgCloudRadY = avgDataset{uniqScanIter}.avgCloudRadY;   stdCloudRadY = avgDataset{uniqScanIter}.stdCloudRadY;
...
%%%%%%%-----------------------------------%%%%%%%%%%
    ...
    default_plot(analyVar,[uniqScanIter length(analyVar.uniqScanList)],...
        figNum,radLabel,radTitle,analyVar.uniqScanList,...
         repmat(indVar,1,2)',[avgCloudRadX'; avgCloudRadY'],'Errorbar',[stdCloudRadX'; stdCloudRadY']);
end
end