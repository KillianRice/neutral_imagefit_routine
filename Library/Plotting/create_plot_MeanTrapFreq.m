...
for uniqScanIter = 1:length(analyVar.uniqScanList);
    ...
    avgTrapFreq = avgDataset{uniqScanIter}.avgTrapFreq; stdTrapFreq = avgDataset{uniqScanIter}.stdTrapFreq;
...
%%%%%%%-----------------------------------%%%%%%%%%%
    ...
    default_plot(analyVar,[uniqScanIter length(analyVar.uniqScanList)],...
        ...
        analyVar.funcDataScale(indVar)',avgTrapFreq','Errorbar',stdTrapFreq');
end
end